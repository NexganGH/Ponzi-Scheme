...
class PonziPlotter:
    ...
    def add_simulation(self, simulation_result, label: str = None, show_potential=True):
        """Adds a simulation result to the plotter."""
        self.simulations.append((simulation_result, label, show_potential))

    def plot(self, file_name='asd'):
        ...
        for idx, (simulation_result, label, show_potential) in enumerate(self.simulations):
